...
async function main() {
    ...
    let result = await createSchedule(account1AccountId, account2AccountId, myClient, myPrivateKey, "Scheduled Transaction By Ayushi Agrawal.");
    ...
    console.info('schedule transaction delete status: ' + executeScheduledTx.toString()/n);
